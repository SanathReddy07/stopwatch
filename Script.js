window.onload = function () {
    ...
    let lapBtn = document.querySelector('#lap'); // Added lap button
    let lapTimesContainer = document.querySelector('#lap-times'); // Added lap time display area
    let Interval;
    let lapCounter = 1;
    ...
    const startTimer = () => {
        ...
        // Check if it's time for a new lap
